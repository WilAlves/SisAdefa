...
<html>
    ...
    <label>Lista de Alunos:</label><hr>
            <table align="center" class="boxSearch">
                <tr>
                    <td><label>Nome: </label><labelR></labelR></td>
                    <td><label>Tipo de Defici&ecirc;ncia:</label><labelR></labelR></td>
                    ...
                    <tr bgcolor="<?=$cor;?>">
                           <td><?=$font.$vetor['NomeAluno'].$font;?></td>
                           <td><?php echo $vetor['TpDeficAluno'];?></td>
                           <td align="center"><a href="dadoscompleto.php?Codigo=<?php $vetor['Codigo'];?>">
                           <img src="imagens/detalhes.png" border="0" title="Clique aqui para ver DETALHES do deficiente"></a></td>
                    </tr>
          <?php    } ?>
        </table>
</body>
