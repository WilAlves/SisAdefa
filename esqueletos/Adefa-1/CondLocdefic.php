...
include("conecta.php");
include("funcoes.php");
$codigo=UltimoCodigoCondLocDeficientes()+1;

if ($acao =='salvar')
{
$descricao = strtoupper ($descricao);
$sql = pg_query("INSERT INTO condlocdeficientes(codigo,descricao)
...
echo"<script>location='CondLocdefic.php';</script>";
}
}
?>

<html><head>
<title>Cadastro de Condições de Locomoção da deficiente</title>
<body Bgcolor="Silver">
...
<font color="blue" size="4" face="Times New Roman">CADASTRO DE CONDIÇOES DE LOCOMOÇÃO</font></td></tr>
