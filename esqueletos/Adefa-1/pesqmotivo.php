...
$sql = pg_query("SELECT motivo, count(motivo) FROM tabdeficientes GROUP BY 1 ORDER BY 1;");
...
<tr>
<td align="center" colspan="6"><?php echo $font2."QUANTIDADE DE DEFICIENTES POR MOTIVO QUE LEVOU A  DEFICI&Ecirc;NCIA".$ffont; ?></td>
</tr>
<tr>
...
?>
<tr bgcolor="<?=$cor;?>">
<td align="center"><?=$font.$vetor['motivo'].$ffont;?></td>
