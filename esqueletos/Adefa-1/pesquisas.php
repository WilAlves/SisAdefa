...
$sql = pg_query("SELECT DISTINCT ON (tipodefic,descricao,condloco,motivo)  (tipodefic, descricao, condloco,motivo), count(*) FROM tabdeficientes GROUP BY tipodefic, descricao,condloco,motivo;");
...
<tr>
<td align="center" colspan="6"><?php echo $font2."QUANTIDADE DE DEFICIENTES POR DEFICI&Ecirc;NCIA".$ffont; ?></td>
</tr>
<tr>
...
?>
<tr bgcolor="<?=$cor;?>">
<td align="center"><?=$font.$vetor[0].$ffont;?></td>
...
<div align="center"><input type="button" name="bt" class="button" value="Voltar" onclick="location='menuprincipal.php'"></div>
</body>
</html>
