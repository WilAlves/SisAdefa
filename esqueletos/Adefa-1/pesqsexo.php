...
$sql = pg_query("SELECT sexo, count(sexo) FROM tabdeficientes GROUP BY 1 ORDER BY 1;");
...
<tr>
<td align="center" colspan="6"><?php echo $font2."QUANTIDADE DE DEFICIENTES POR DESCRI&Ccedil;&Acirc;O DA DEFICI&Ecirc;NCIA".$ffont; ?></td>
</tr>
<tr>
<td align="center"><?=$font."SEXO".$ffont; ?></td>
...
?>
<tr bgcolor="<?=$cor;?>">
<td align="center"><?=$font.$vetor['sexo'].$ffont;?></td>
