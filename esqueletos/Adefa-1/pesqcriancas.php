...
$sql = pg_query("SELECT   count (*) FROM tabdeficientes where (dtnascimento between '1999/01/01' and '2011/01/01') ORDER BY 1;");
...
<tr>
<td align="center" colspan="6"><?php echo $font2."QUANTOS DEFICIENTES S&Atilde;O CRIAN&Ccedil;AS".$ffont; ?></td>
</tr>
<tr>
