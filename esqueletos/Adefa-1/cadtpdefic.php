...
include("conecta.php");
include("funcoes.php");
$codigo=UltimoCodigoTipoDeficientes()+1;

if ($acao =='salvar')
{
$descricao = strtoupper ($descricao);
$sql = pg_query("INSERT INTO tpdeficientes(codigo,descricao)
...
<html><head>
<title>Cadastro de tipos de deficiêcia</title>
<body Bgcolor="Silver">
...
<font color="blue" size="4" face="Times New Roman">CADASTRO DE TIPOS DE DEFICIENCIA</font></td></tr>
