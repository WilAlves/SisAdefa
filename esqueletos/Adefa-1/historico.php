...
<tr><td rowspan="2" align="center" bgcolor="#E8E8E8">FILIAÇÃO  PAI / MÃE</td><td align="" bgcolor="#E8E8E8"><input type="text" name="pai" id="pai" size="100" value="<?php echo getPai($ficha);?>"></td></tr>
