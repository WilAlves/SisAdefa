...
$sql = pg_query("SELECT instrucao, count(instrucao) FROM tabdeficientes GROUP BY 1 ORDER BY 1;");
...
<tr>
<td align="center" colspan="6"><?php echo $font2."QUANTIDADE DE DEFICIENTES POR GRAU DE INSTRU&Ccedil;&Atilde;O".$ffont; ?></td>
</tr>
<tr>
...
?>
<tr bgcolor="<?=$cor;?>">
<td align="center"><?=$font.$vetor['instrucao'].$ffont;?></td>
