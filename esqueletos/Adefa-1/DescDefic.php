...
include("conecta.php");
include("funcoes.php");
$codigo=UltimoCodigoDescDeficientes()+1;

if ($acao =='salvar')
{
$descricao = strtoupper ($descricao);
$sql = pg_query("INSERT INTO descdeficientes(codigo,descricao)
...
echo"<script>location='cadtpdefic.php';</script>";
}
}
?>

<html><head>
<title>Cadastro de descrição de deficiêcia</title>
<body Bgcolor="Silver">
...
<font color="blue" size="4" face="Times New Roman">CADASTRO DE DESCRIÇÕES DE DEFICIENCIA</font></td></tr>
