...
$sql = pg_query("SELECT tipodefic, count(tipodefic) FROM tabdeficientes GROUP BY 1 ORDER BY 1;");
...
<tr>
<td align="center" colspan="6"><?php echo $font2."QUANTIDADE DE DEFICIENTES POR TIPOS DE DEFICI&Ecirc;NCIA".$ffont; ?></td>
</tr>
<tr>
...
?>
<tr bgcolor="<?=$cor;?>">
<td align="center"><?=$font.$vetor['tipodefic'].$ffont;?></td>
